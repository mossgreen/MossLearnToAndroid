...
/**
 * @author Originally from com.victor.marslander_2015, modified by Feifei GU
 *         Jan/11/2016. 
 *         
 *         This is an assignment of subject ISCG7424 Mobile Application
 *         Development. 
 *         
 *         This class is mainly used for draw the mars lander view
...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback, Runnable {
	...
	private void rotateCraft(Craft craft) {
		 ...
		 * set it can be rotated only in condition of running status
		 */
		if (gameLoop.getState() == GameLoop.STATE_RUNNING)  {
			matrix.reset();
