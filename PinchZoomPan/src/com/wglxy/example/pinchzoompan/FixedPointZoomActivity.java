...
/**
 * This activity displays a grid of image squares that is roughly three times  as wide as the screen.
 * The image can be zoomed in or out. The zoom point is fixed at the center of the grid.
 */
